...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/phx/.eclipse/org.eclipse.platform_3.8_155965261/plugins/org.eclim_1.7.13'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/phx/.eclipse/org.eclipse.platform_3.8_155965261'
  if has('win32unix')
